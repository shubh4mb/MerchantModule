...
import type { Product, Variant, ChangedStock } from "./Types/ProductTypes";
    ...
    <div className="!px-24 bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen font-sans">
        ...
        {brands.length === 0 ? (
          <div className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-300 rounded-2xl !p-8 flex items-center !gap-6 opacity-50 pointer-events-none cursor-not-allowed grayscale brightness-90 shadow-inner">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-bold text-gray-400 !mb-2 tracking-wide">
                NEW PRODUCT
              </h3>
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="text-xl font-bold text-slate-800 !mb-2 tracking-wide">
                NEW PRODUCT
              </h3>
              <p className="text-sm text-slate-500">Add new items to inventory</p>
            </div>
            <div className="text-2xl text-slate-400 ml-auto transition-all duration-300 group-hover:translate-x-2 group-hover:text-slate-600">
              →
            </div>
          </Link>
        )}
      ...
      <div className="bg-white rounded-3xl !p-8 !mt-8 shadow-xl">
        <div className="flex justify-between items-center !mb-8 !pb-4 border-b-4 border-slate-100 flex-wrap !gap-4">
          <h2 className="text-4xl font-extrabold text-slate-900 tracking-wider uppercase flex-shrink-0">
            INVENTORY
          </h2>

          {/* Search */}
          <div
            className={`relative w-[450px] min-w-[300px] max-w-full transition-all duration-300 ${
              isSearchFocused ? "focused" : ""
            }`}
          >
            <div
              className={`relative flex items-center bg-gradient-to-br from-white to-slate-50 border-2 rounded-3xl shadow-md transition-all duration-400 overflow-hidden backdrop-blur-sm h-14 ${
                isSearchFocused
          ...
          <div className="flex !gap-4">
            ...
            <span className="bg-gradient-to-br from-amber-50 to-amber-200 !px-5 !py-3 rounded-xl text-sm font-semibold text-amber-900 border border-amber-200 transition-all duration-300 shadow-sm hover:-translate-y-0.5 hover:shadow-lg">
              {filteredProducts.reduce(
                (total, product) =>
                  total + getTotalStock(product.variants),
                0
              )}{" "}
              Total Units
            </span>
        ...
        <div className="flex flex-col !gap-6">
          {filteredProducts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center !py-16 !px-8 text-center text-slate-500">
              ...
              <p className="text-white-500 text-sm max-w-sm">
                Try adjusting your search terms or add new products to your
                inventory.
              </p>
            </div>
          )}
